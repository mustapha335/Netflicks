    ...
    const getNewUsers = async () => {
      try {
        const res = await axios.get("/users?new=true", {
          headers: {
            token:
              "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYxMzg4ZjkxNTBlOGRlNTgxYWE3ODIwYiIsImlzQWRtaW4iOnRydWUsImlhdCI6MTYzMTExMTE1OCwiZXhwIjoxNjMxNTQzMTU4fQ.o04mutdZiy22FW_lUpydON3820fgVubE3tITlq8zO7U",
          },
        });
